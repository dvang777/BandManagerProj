namespace BandManager.Migrations
{
    ...
    public partial class InitialMigration : DbMigration
    {
        ...
        public override void Down()
        {
            ...
            DropForeignKey("dbo.Inventories", "band_ID", "dbo.Bands");
            DropForeignKey("dbo.Events", "band_ID", "dbo.Bands");
            ...
            DropIndex("dbo.Inventories", new[] { "band_ID" });
            DropIndex("dbo.Events", new[] { "band_ID" });
